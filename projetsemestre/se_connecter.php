			...
			<div class="inner1">
			  ...
			  <form action="commencer.php" method="POST">
				  <div class="form-group">
					...
					<input type="email" required name="mail" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Adresse e-mail">
					<small id="emailHelp" class="form-text text-muted"></small>
				  </div>
				  <div class="form-group1">
					<label for="exampleInputPassword1"></label>
					<input type="password" required name="mdp" class="form-control" id="exampleInputPassword1" placeholder="Mot de passe">
				  </div>
